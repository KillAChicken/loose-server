...
@pytest.fixture
def registered_rule_prototype(server_rule_factory, server_rule_prototype):
    ...
    server_rule_factory.register_rule(rule_type=rule_type, parser=parser, serializer=serializer)

    return server_rule_prototype.create_new(rule_type=rule_type)


@pytest.fixture
def registered_response_prototype(server_response_factory, server_response_prototype):
